        ...
        return this.each(function () {
            ...
            function columnize($putInHere, $pullOutHere, $parentColumn, height) {
                while ($parentColumn.height() < height && $pullOutHere[0].childNodes.length) {
                    console.log('prev', $parentColumn.height() );
                    $putInHere.append($pullOutHere[0].childNodes[0]);
                    console.log($pullOutHere[0].childNodes[0], $($pullOutHere[0].childNodes[0]).height());
                    if ($pullOutHere[0].childNodes[0]) {
                        console.log('next', $parentColumn.height());
                        console.log('next', $parentColumn.html());
                    }
                }
