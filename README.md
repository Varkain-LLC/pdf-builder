...
python converter.py -j assets/jrnl-example2.json -tid jrnl -o test.pdf -e 1

python html2pdf_converter/converter.py -j assets/jrnl-example2.json -tid jrnl-cover -o test-cover.pdf -e 0